...
namespace Backend_Escaperoom_2.Application.Validations.WebApi.TiposParticipantes
{
    public class UpdateTipoParticipanteValidation : AbstractValidator<UpdateTipoParticipanteResquest>
    {
        ...
        public UpdateTipoParticipanteValidation(ITipoParticipantesRepositoryAsync TipoParticipantesRepositoryAsync, IEscapeRoomsRepositoryAsync escapeRoomsRepositoryAsync,
            LanguagesHelper languagesHelper)
        {
            ...
            RuleFor(p => p.Estado).Cascade(CascadeMode.Stop)
                .NotNull().WithMessage("Seleccione el 'Estado' del tipo del participante.");
