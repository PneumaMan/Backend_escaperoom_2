...
namespace Backend_Team_2.Application.Validations.WebApi.Teams
{
    public class CreateTeamValidation : AbstractValidator<CreateTeamResquest>
    {
        ...
        public CreateTeamValidation(ITeamsRepositoryAsync teamsRepositoryAsync, IEscapeRoomsRepositoryAsync escapeRoomsRepositoryAsync,
            LanguagesHelper languagesHelper)
        {
            ...
            RuleFor(p => p.EscapeRoomId).Cascade(CascadeMode.Stop)
                .NotNull().WithMessage("Seleccione el 'Escape Room' para registrar el equipo.")
