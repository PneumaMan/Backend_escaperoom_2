...
{
    public class CreateEscapeRoomValidation : AbstractValidator<CreateEscapeRoomResquest>
    {
        ...
        public CreateEscapeRoomValidation(IEscapeRoomsRepositoryAsync escapeRoomsRepositoryAsync, LanguagesHelper languagesHelper)
        {
            ...
            RuleFor(p => p.NombreEscapeRoom).Cascade(CascadeMode.Stop)
                ...
                .MustAsync(IsExistNombreEscapeAsync).WithMessage(this._languagesHelper.EscapeRoomExiste);
        ...
        private async Task<bool> IsExistNombreEscapeAsync(string NombreEscape, CancellationToken cancellationToken)
        {
            return await _escapeRoomsRepositoryAsync.IsExistAttributeAsync(e => !e.NombreEscapeRoom.ToLower().Equals(NombreEscape.ToLower()));
        }
